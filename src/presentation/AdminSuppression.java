...
public class AdminSuppression extends JFrame implements MouseListener, ActionListener,KeyListener {
    ...
    AdminSuppression() {
        ...
        try {
            ResultSet rs = dai.retournerListeDemandeSelonTypeDemande("suppression");
            while (rs.next()) {
        ...
        panel2.add(searchLabel);//label "recherche"
        panel2.add(searchLabel1);//icon recherche.
        ...
        button2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (table.getSelectedRowCount() > 0) {
                    ...
                    for (Integer x : rs) {
                        model.setValueAt(1, x, 11);// elle est traiter.
                        model.setValueAt(1, x, 10);//accepter la demmande de supprition 
                    }
                    ...
                    dai.closeProjet(nomCourt, typeDemande);
                    dai.supprimerDeGroupe(nomCourt);
                    dai.supprimerdeAppartenir(nomCourt);

                    JOptionPane.showMessageDialog(table, "l'acceptation de demande est réussi !");
                } else {
